...
<?php
//print the output, with search terms removed and a clickable name for each line
$foundName = "";
if($condition != "")
{
	//Search database
	$results2 = mysql_query('SELECT * FROM inventory WHERE '.$condition) or die(mysql_error());
?>
	<table border="1">
	<tr>
	<th>Data Name</th>
